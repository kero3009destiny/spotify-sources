...
class TrackRating extends Component {
  ...
  render() {
    ...
    const emojiScale = question.params.scale;
    ...
    return (
      <section className="question question--track-rating">
...
// WEBPACK FOOTER //
// ./src/components/questions/TrackRating.js