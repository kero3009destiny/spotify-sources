import _toConsumableArray from "/var/jenkins_home/workspace/tingle.a074a366-9339-45fe-940a-3742034896fd/workspace/node_modules/next/node_modules/@babel/runtime/helpers/esm/toConsumableArray";
import _defineProperty from "/var/jenkins_home/workspace/tingle.a074a366-9339-45fe-940a-3742034896fd/workspace/node_modules/next/node_modules/@babel/runtime/helpers/esm/defineProperty";
...
var PageRoute = dynamic(function () {
  ...
  loadableGenerated: {
    ...
    modules: ["../lib/createPage/index.tsx -> " + './PageRoute']
  }
});
...
export function createPage(route) {
  var PageRouteToUse = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : PageRoute;
