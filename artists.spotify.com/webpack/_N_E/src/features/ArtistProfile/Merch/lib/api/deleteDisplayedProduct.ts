...
export function useDeleteDisplayedProduct() {
  ...
  React.useEffect(function () {
    function deleteDisplayedProducts() {
      return _deleteDisplayedProducts.apply(this, arguments);
    }

    function _deleteDisplayedProducts() {
      _deleteDisplayedProducts = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
        var resp;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 6:
                ...
                if (!resp.ok) {
                  setError(new Error("".concat(artistID, "/displayed-products DELETE failed with: ").concat(resp.status)));
                }
    ...
    deleteDisplayedProducts();
  }, [artistID, productID]);
  return {
    deleteDisplayedProduct: setProductID,
    loading: loading,
    error: error
  };
}