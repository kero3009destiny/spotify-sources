    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            baseUrl = "".concat(S4X_DATA_API, "/v2/artist/").concat(props.artistId, "/recording/").concat(props.songId, "/summary-table?time-filter=").concat(props.timeFilter);
...
var summaryTableLoader = createLoader(load, {
...
export function useSummaryTableData(artistId, songId, timeFilter, startDate, endDate) {
  useEffect(function () {
    return function cleanup() {
      summaryTableLoader.clear({
        artistId: artistId,
        songId: songId,
  ...
  return useRead(summaryTableLoader, {
    artistId: artistId,
    songId: songId,
    timeFilter: timeFilter,
    startDate: startDate,
