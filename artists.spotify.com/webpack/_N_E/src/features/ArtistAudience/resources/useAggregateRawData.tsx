      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "".concat(S4X_DATA_API, "/v1/artist/").concat(props.artistId, "/audience/aggregate-delta?").concat(qs.stringify(props.queryParams, false), "&aggregation-level=recording").concat(countryCode);
            _context.prev = 2;
            _context.next = 5;
...
var useAggregateLoader = createLoader(load, {
...
setInterval(function () {
  useAggregateLoader.clearAll();
}, SIX_HOURS);
export function useAggregateRawData(queryParams, country) {
  var artist = useCurrentArtist();
  var artistId = artist.id;
  var countryCode = country.code;
  return useRead(useAggregateLoader, {
    artistId: artistId,
