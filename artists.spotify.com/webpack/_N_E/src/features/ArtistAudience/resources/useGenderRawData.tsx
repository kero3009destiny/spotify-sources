      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "".concat(S4X_DATA_API, "/v1/artist/").concat(props.artistId, "/audience/gender?time-filter=28day&aggregation-level=recording").concat(countryCode);
            _context.prev = 2;
            _context.next = 5;
