...
export var removeTeamMember = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(teamUri, userName) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return _context2.abrupt("return", webgateFetch("".concat(MARKETPLACE_MGMT_API, "/v1/organization/").concat(teamUri, "/member/").concat(userName, "?product=S4A"), {
              method: 'DELETE'
  ...
  return function removeTeamMember(_x, _x2) {
