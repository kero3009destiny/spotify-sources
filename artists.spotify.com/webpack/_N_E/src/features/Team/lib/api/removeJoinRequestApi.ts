...
export var removeJoinRequestApi = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return webgateFetch("".concat(MARKETPLACE_MGMT_API, "/v0/organization/").concat(team.uri, "/accessRequest/").concat(joinRequest.id, "/reject"), {
              method: 'POST'
            });
  ...
  return function removeJoinRequestApi(_x, _x2) {
