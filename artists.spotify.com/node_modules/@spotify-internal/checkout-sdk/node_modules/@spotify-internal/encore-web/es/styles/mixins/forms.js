...
// Forms
// --------------------------------------------------
import { failure, gray10, gray15, gray20, gray30, gray50, gray70, gray95, screenSmMin, screenXsMax, spacer4, spacer8, spacer16, spacer24, spacer32, white } from '@spotify-internal/encore-foundation';
import { css } from 'styled-components';
import { typeStyleBody2 } from "./type";

var borderColor = function borderColor(color) {
  var persistentBorder = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
var formControlMobileStyles = function formControlMobileStyles() {
  return css(["border-radius:0;border-bottom:1px solid;padding-top:10px;padding-bottom:9px;&:focus,&:hover:focus{padding-bottom:", ";border-bottom-width:2px;}"], spacer8);
...
export var formChevronDown = function formChevronDown() {
  return css(["color:", ";pointer-events:none;position:absolute;@media (max-width:", "){right:0;}@media (min-width:", "){right:14px;}"], gray50, screenXsMax, screenSmMin);
}; // Shared styles for radios + checkboxes

export var formCheck = function formCheck() {
  return css(["align-items:center;display:flex;padding-bottom:", ";padding-top:", ";position:relative;min-height:", ";"], spacer4, spacer4, spacer32);
};
...
export var formControlTheme = function formControlTheme() {
  ...
  // Dark Theme
  if (theme === 'dark') {
    return css(["background-color:", ";", ";color:", ";&:focus,&:hover:focus{", ";}&::placeholder{color:", ";}&:disabled,&[readonly]{", ";color:", ";@media (min-width:", "){background-color:", ";}}&:invalid,&:invalid:hover{", ";}@media (min-width:", "){background-color:", ";}"], themeDarkBackgroundDefaultXs, borderColor(themeDarkBorderDefault, persistentBorder), themeDarkColorDefault, borderColor(themeDarkBorderFocus, persistentBorder), themeDarkColorPlaceholder, borderColor(themeDarkBorderDisabled, persistentBorder), themeDarkColorDisabled, screenSmMin, themeDarkBackgroundDisabled, error === undefined && borderColor(themeDarkBorderError, persistentBorder), screenSmMin, themeDarkBackgroundDefault);
  } // Light Theme


  return css(["background-color:", ";", ";color:", ";&:focus,&:hover:focus{", ";}&::placeholder{color:", ";}&:disabled,&[readonly]{", ";color:", ";@media (min-width:", "){background-color:", ";}}&:invalid,&:invalid:hover{", ";}"], themeLightBackgroundDefault, borderColor(themeLightBorderDefault, persistentBorder), themeLightColorDefault, borderColor(themeLightBorderFocus, persistentBorder), themeLightColorPlaceholder, borderColor(themeLightBorderDisabled, persistentBorder), themeLightColorDisabled, screenSmMin, themeLightBackgroundDisabled, error === undefined && borderColor(themeLightBorderError, persistentBorder));
};
...
export var formControlErrorTheme = function formControlErrorTheme() {
  ...
  return css(["&,&&&,&:hover,&:hover:focus{", ";}"], borderColor(errorTheme, persistentBorder));
};