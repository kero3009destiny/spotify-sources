...
import { useFocusWithin, isFocusVisible, useHover } from "@react-aria/interactions";
...
export function useOption(props, state, ref) {
  ...
  return {
    optionProps: _babelRuntimeHelpersEsmExtends({}, optionProps, mergeProps(itemProps, hoverProps), {
