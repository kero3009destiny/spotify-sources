...
})(["border-radius:4px;ol,ul{list-style:none !important;margin-inline-start:0 !important;padding-inline-start:0 !important;}&& a:hover{color:", ";outline:none;background-color:transparent;}", ""], _encoreFoundation.gray45, function (props) {
  return props.theme === PopoverNavigationOverrides.darkTheme && "\n    a {\n      color: white;\n    }\n\n    && a:hover {\n      color:".concat(_encoreFoundation.gray75, ";\n    }\n  ");
});
