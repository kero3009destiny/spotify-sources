...
const WithTooltipComponent = (_a) => {
    ...
    return (React.createElement(TooltipTrigger, { style: { display: 'unset', width: 'fit-content' }, className: className, placement: placement, withPortal: withPortal, overlay: (open !== null && open !== void 0 ? open : showTooltip) &&
            (overlay !== null && overlay !== void 0 ? overlay : (content && (React.createElement(StyledTooltip, Object.assign({ id: tooltipId.current, width: width, onMouseEnter: handleOnShow, onMouseLeave: handleOnHide, style: style }, props), content)))), onShow: e => handleOnShow(e), onHide: e => handleOnHide(e) }, children));
};
