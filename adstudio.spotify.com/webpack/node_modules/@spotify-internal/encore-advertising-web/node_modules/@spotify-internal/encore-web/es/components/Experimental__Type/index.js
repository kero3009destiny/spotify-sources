...
var TypeComponent = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  var color = _ref.color,
      ...
      props = _objectWithoutProperties(_ref, ["color", "paddingBottom", "pxLegacy", "variant"]);

  return /*#__PURE__*/React.createElement(TypeElement, Object.assign({
    variant: variant,
    typeColor: isColorToken(color) ? colorTokens[color] : color,
...
*
* [GitHub](https://ghe.spotify.net/encore/web/tree/master/src/components/Experimental__Type) | [Storybook](https://encore-web.spotify.net/?path=/story/components-type-experimental-type--scale) | [Encore](https://encore.spotify.net/web/components/type) | 
*
* null
*
* @example
