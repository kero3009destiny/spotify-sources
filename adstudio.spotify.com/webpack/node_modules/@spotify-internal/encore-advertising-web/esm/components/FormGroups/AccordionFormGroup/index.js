...
export const AccordionFormGroup = (_a) => {
    ...
    return (React.createElement(CollapsibleFormGroupHelper, Object.assign({}, formGroupProps, { isExpanded: isExpanded, icon: React.createElement(ArrowIcon, { iconSize: 16, isExpanded: isExpanded }), onLabelClick: onLabelClick }), children));
};
