...
export const EditableFormGroup = (_a) => {
    ...
    return (React.createElement(CollapsibleFormGroupHelper, Object.assign({}, formGroupProps, { isExpanded: !!isEditing, disabled: disabled, onLabelClick: () => setIsEditing(prev => {
            const newIsEditing = !prev;
            onChange === null || onChange === void 0 ? void 0 : onChange(newIsEditing);
            if (newIsEditing)
                onEdit === null || onEdit === void 0 ? void 0 : onEdit();
            if (!newIsEditing)
                onClose === null || onClose === void 0 ? void 0 : onClose();
            return isEditingProp !== null && isEditingProp !== void 0 ? isEditingProp : newIsEditing;
        }), extra: ((isEditing && !hideClose) || !isEditing) && (React.createElement(EditCloseButton, { isEditing: isEditing, editText: editText, closeText: closeText, disabled: disabled, "data-testid": "button", onEdit: () => {
