...
const StyledButton = styled(ButtonTertiary) `
  ...
  /*
  This :after bandaid fixes a bug with focusBorders in Encore Web v3, which likely doesn't
  exist in v4. Specifically, sometimes there is a dark line that appears slightly
  above the button and looks wrong.
  */
  &:focus::after {
    border-bottom: none;
  }
