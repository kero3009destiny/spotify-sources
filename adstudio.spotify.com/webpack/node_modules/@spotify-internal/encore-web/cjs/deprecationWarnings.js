...
exports.componentDeprecationWarning = componentDeprecationWarning;
exports.deprecatedPropWarning = deprecatedPropWarning;
exports.renamedPropWarning = renamedPropWarning;

function deprecatedPropWarning(oldProp, message) {
  /* eslint-disable-next-line no-console */
  console.warn("The ".concat(oldProp, " prop has been deprecated. ").concat(message || ''));
}

function renamedPropWarning(oldProp, newProp, additionalInfo) {
  /* eslint-disable-next-line no-console */
  console.warn("The ".concat(oldProp, " prop has been deprecated. Please use ").concat(newProp, " instead. ").concat(additionalInfo || ''));
}

function componentDeprecationWarning(oldComponent, newComponent, version, additionalInfo) {
  /* eslint-disable-next-line no-console */
