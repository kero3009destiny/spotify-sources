...
import { Experimental__IconExclamationAltActive as IconExclamationAltActive } from "../Experimental__Icon/icons/Experimental__IconExclamationAltActive";
var IconExclamationAltActiveForText = styled(IconExclamationAltActive).attrs({
  iconSize: 16
}).withConfig({
  displayName: "FormHelpText__IconExclamationAltActiveForText",
...
export var FormHelpText = function FormHelpText(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Help, Object.assign({
    error: error
  }, props), error && /*#__PURE__*/React.createElement(IconExclamationAltActiveForText, {
    "aria-label": "Error:"
  }), children);
};
/**
